...
!function (t, e, n, i, r, o, a, d, s, c, l, p) {
  function u() {
    p ||
      (p = 1,
        ...
        (s = e.querySelectorAll('script[type="text/partytown"]'),
          i != t
            ...
            : (d = setTimeout(f, 1e4),
              ...
              r ? h(1) : n.serviceWorker
                ? n.serviceWorker.register(
                  a + (o.swPath || "partytown-sw.js"),
                  { scope: a },
                ).then(function (t) {
                  t.active ? h() : t.installing &&
  ...
  function h(t) {
    c = e.createElement(t ? "script" : "iframe"),
      ...
      c.src = a + "partytown-" +
        (t ? "atomics.js?v=0.8.0" : "sandbox-sw.html?" + Date.now()),
      e.querySelector(o.sandboxParent || "body").appendChild(c);
  }
  function f(n, r) {
    for (
      w(),
        i == t && (o.forward || []).map(function (e) {
          delete t[e.split(".")[0]];
        }),
        n = 0;
      n < s.length;
